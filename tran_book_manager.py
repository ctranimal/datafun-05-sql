...
db_file_path = pathlib.Path("database").joinpath("tran_project05_database.db")
sql_file_path = pathlib.Path("sql_create").joinpath("02_create_tables.sql")
student_data_path = pathlib.Path("data").joinpath("students.csv")
testscore_data_path = pathlib.Path("data").joinpath("testscores.csv")
...
def main():
    ...
    insert_data_from_csv(db_file_path, student_data_path, testscore_data_path)
